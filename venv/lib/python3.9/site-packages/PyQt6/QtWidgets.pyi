...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def grabGesture(self, type: int, flags: QtCore.Qt.GestureFlag = ...) -> None: ...
...
class QScroller(QtCore.QObject):
    ...
    @staticmethod
    def grabGesture(target: QtCore.QObject, scrollGestureType: 'QScroller.ScrollerGestureType' = ...) -> int: ...
    @staticmethod
